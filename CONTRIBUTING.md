...
## Contributing to andino_webots

The following is a set of guidelines for contributing to andino_webots project.
...
* **Which version of andino_webots are you using?**?
* **What's the name and version of the OS you're using**?
* **Are you running andino_webots using the provided docker container?** See [docker](docker/README.md).
* **Are you running andino_webots in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/andino_webots/issues?q=is%3Aissue) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
* **Specify which version of andino_webots you're using.**
...
#. **Fork the andino_webots package** you want to contribute to. This will create
